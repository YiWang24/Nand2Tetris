...
function parser(input) {
  ...
  return {
    ...
    dest: () => {
      if (currentInstruction.includes("=")) return currentInstruction.split("=")[0];
      return "null";
    },
    comp: () => {
      let comp = currentInstruction;
      if (currentInstruction.includes("=")) comp = currentInstruction.split("=")[1];
      if (currentInstruction.includes(";")) comp = currentInstruction.split(";")[0];
      return comp;
    },
    jump: () => {
      if (currentInstruction.includes(";")) return currentInstruction.split(";")[1];
      return "null";
    },
  };
}
